...
const Register = () => {
  ...
  return (
    ...
    <Form.Group className="mb-3 displayName-form-group" controlId="formBasicDisplayName">
    ...
    <Form.Group className="mb-3" controlId="formBasicPassword">
      ...
      <Form.Control className="password-confirm" type="password" placeholder="Confirm Password" required
        value={ confirmPassword } onChange={e => setConfirmPassword(e.target.value)}/>
    </Form.Group>
    <span className="register">
      already have a user? <a className="register-link" href="/login">login!</a>
    </span>
